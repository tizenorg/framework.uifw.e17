...
typedef struct _E_Config_Desktop_Layout     E_Config_Desktop_Layout;
...
struct _E_Config
{
   ...
   unsigned char deiconify_approve;
...
#ifdef _F_USE_TILED_DESK_LAYOUT_
struct _E_Config_Desktop_Layout
{
   int         container;
   int         zone;
   int         desk_x;
